...
const Service = ({image,cardTitle, text}) => {
    return (
        <div className='z-10 bg-[#042423] lg:w-[78rem] shadow-black shadow-[2px_-2px_10px_rgba(0,0,0,0.2),10px_10px_15px_rgba(0,0,0,0.2)]'>
            <Image
            src={image}
            alt={image}
            ></Image>
            ...
            <div className='lg:h-[24.6rem] relative'>
                ...
                <h1 className='pb-[1.7rem] pt-[3rem] text-[#BCA263] lg:text-[2.7rem] text-[1.6rem] text-center'
                style ={{fontFamily: cinzel.style.fontFamily, fontWeight: '700' }}>{cardTitle}</h1>

                <div className='flex justify-center items-center'>
                    <hr className='border-[#BCA263] lg:w-[12rem] pb-[2.375rem]'/>
                </div>
                ...
                <div className='flex justify-center items-center'>
                    <Image className='lg:w-[16rem] w-[6rem]' src={cardFinisher} alt={cardFinisher}></Image>
                </div>
